...
return [
    ...
    'playTypePatterns' => [
        ...
        'scrambles' => 'Scrambles',
        'up the middle' => 'Run Middle',
        'left guard' => 'Run Left guard',
        'right guard' => 'Run Right guard',
        'left tackle' => 'Run Left tackle',
        'right tackle' => 'Run Right tackle',
        'left end' => 'Run Left end',
        'right end' => 'Run Right end',
        'punts' => 'Punt',
    ...
    'weeks' => [
        1 => ['start' => '2024-08-20', 'end' => '2024-08-31'],
