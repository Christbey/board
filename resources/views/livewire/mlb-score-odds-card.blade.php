        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">{{ \App\Helpers\FormatHelper::formatOdds($odd->spread_home_price) }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">{{ \App\Helpers\FormatHelper::formatOdds($odd->total_over_price) }}</td>
                </tr>
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">{{ \App\Helpers\FormatHelper::formatOdds($odd->spread_away_price) }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">{{ \App\Helpers\FormatHelper::formatOdds($odd->total_under_price) }}</td>
                </tr>
                </tbody>
            </table>
        </div>
